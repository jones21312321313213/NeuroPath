...
# -------------------------------------------------------------------
# SUBSYSTEM 1: CORE IEP DOCUMENT (Includes Image Section B)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# SUBSYSTEM 2: AI-GENERATED GOALS (Includes Image Section C)
# -------------------------------------------------------------------
...
# Note: The unused duplicate 'IEP' model from your original file was safely 
# removed to prevent database collision. The API strictly uses 'IEPModel'.