...
def dashboard_stats(request):
    ...
    - Active IEPs: distinct IEPModel records linked to the teacher's students.
    - AI Insights Generated: total GeneratedAIInsight records created by this teacher.
    """
    teacher = request.user

    # Count IEPs belonging to students of this teacher
    active_ieps = IEPModel.objects.filter(
        studentID__teacherID=teacher
    ).count()

    # Count all AI insights generated by this teacher across all students
